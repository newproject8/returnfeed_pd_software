...
logger.info("="*80)
logger.info("PD 통합 소프트웨어 v2.1 (Fixed) 시작")
logger.info("="*80)
...
def main():
    ...
    try:
        ...
        # 스타일 설정
        app.setStyle('Fusion')
        app.setApplicationName("PD 통합 소프트웨어 v2.1 (Fixed)")
        ...
        try:
            from pd_app.ui.main_window_fixed import MainWindowFixed as MainWindow
