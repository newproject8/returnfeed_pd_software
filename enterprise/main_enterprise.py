...
Production-ready with zero GUI freezing and real-time performance
Combines validated patterns from vMix_tcp_tally2.py with enterprise NDI
"""
...
logger = setup_logger("enterprise")
...
# Enterprise components - 상대 경로 처리
try:
...
class MainWindowEnterprise(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PD 통합 소프트웨어 - Enterprise Edition")
...
def main():
    """Main entry point"""
    logger.info("="*80)
    logger.info("PD 통합 소프트웨어 Enterprise Edition")
    logger.info("="*80)
